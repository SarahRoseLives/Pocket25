  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Row(
          children: [
            // Left column - RTL Source & Connection
            Expanded(
              child: ListView(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.usb, color: Colors.blue[300], size: 20),
            ...
            const SizedBox(height: 12),
            // Radio group for RTL source selection
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.router, color: Colors.cyan[300], size: 20),
                const SizedBox(width: 8),
                Text(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.tune, color: Colors.green[300], size: 20),
                const SizedBox(width: 8),
                const Text(
                  'Tuning',
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.play_circle, color: Colors.amber[300], size: 20),
                const SizedBox(width: 8),
                const Text(
                  'Scanner Control',
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
